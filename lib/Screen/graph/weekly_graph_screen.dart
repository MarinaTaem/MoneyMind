...
class WeeklyGraphScreen extends StatefulWidget {
  final int userId;
  final List<Transaction>? transaction;
  WeeklyGraphScreen({super.key, required this.userId, this.transaction});

  @override
  State<WeeklyGraphScreen> createState() => _WeeklyGraphScreenState();
}

class _WeeklyGraphScreenState extends State<WeeklyGraphScreen> {
  ...
  Widget build(BuildContext context) {
    final weeklyTotal = calculateWeeklyTotals(transactions);
    income = weeklyTotal['income']!;
    expense = weeklyTotal['expense']!;

    final now = DateTime.now();
    // Filter transactions for the current month
    final currentMonthTransactions = transactions
        .where((t) =>
            t.dateRecord.year == now.year && t.dateRecord.month == now.month)
        .toList();
